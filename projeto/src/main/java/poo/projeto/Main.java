...
public class Main extends javax.swing.JFrame {
    ...
    private void btnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarActionPerformed
        ...
        if (Cadastro.autenticacaoUsuario(inputUsuario.getText())) {
            erroUsuario.setVisible(false);
            
            if (Cadastro.autenticacaoSenha(String.valueOf(inputSenha.getPassword()))) {
                erroSenha.setVisible(false);
            } else {
        ...
        if (Cadastro.autenticacaoUsuario(inputUsuario.getText()) 
        && Cadastro.autenticacaoSenha(String.valueOf(inputSenha.getPassword()))) {
            Cadastro.imprimirUsuario(inputUsuario.getText());
