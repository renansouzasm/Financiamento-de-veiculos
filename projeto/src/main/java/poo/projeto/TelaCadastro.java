...
public class TelaCadastro extends javax.swing.JFrame {
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        if (cadastro.autenticaUsuario(inputNovoUsuario.getText())) {
            ...
            try { 
                usuario = inputNovoUsuario.getText();
                senha = inputNovaSenha.getText();
                cpf = Integer.parseInt(inputNovoCpf.getText()); 
                dataNascimento = Integer.parseInt(inputNovaDataNascimento.getText());
                
                Cadastro.insert(new Cadastro(usuario, senha, cpf, dataNascimento));
