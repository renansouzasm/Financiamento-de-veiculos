...
public class TelaCatalogo extends javax.swing.JFrame {
    ...
    private void btnEdicaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEdicaoActionPerformed
        if (cadastro.getCurrentUser().equals("adm")) {
    ...
    */
    ...
    private void adicinarVeiculos() {
        info = inputAdd.getText();
        Financiamento.setChoice(info);
        inputAdd.setText("");
    }
    ...
    public void imprimirCatalogo() {
        ...
        if (Financiamento.size >= 1) {
            cardTitle1.setText(Financiamento.listaVeiculos.get(0).getNome());
            nome1.setText("Nome: " + Financiamento.listaVeiculos.get(0).getNome());
            fabricante1.setText("Fabricante: " + Financiamento.listaVeiculos.get(0).getFabricante());
            id1.setText("ID: " + String.valueOf(Financiamento.listaVeiculos.get(0).getId()));
            valor1.setText("Valor: R$ " + String.valueOf(Financiamento.listaVeiculos.get(0).getValor()));
        }
        
        if (Financiamento.size >= 2) {
            cardTitle2.setText(Financiamento.listaVeiculos.get(1).getNome());
            nome2.setText("Nome: " + Financiamento.listaVeiculos.get(1).getNome());
            fabricante2.setText("Fabricante: " + Financiamento.listaVeiculos.get(1).getFabricante());
            id2.setText("ID: " + String.valueOf(Financiamento.listaVeiculos.get(1).getId()));
            valor2.setText("Valor: R$ " + String.valueOf(Financiamento.listaVeiculos.get(1).getValor()));
        }
        
        if (Financiamento.size >= 3) {
            cardTitle3.setText(Financiamento.listaVeiculos.get(2).getNome());
            nome3.setText("Nome: " + Financiamento.listaVeiculos.get(2).getNome());
            fabricante3.setText("Fabricante: " + Financiamento.listaVeiculos.get(2).getFabricante());
            id3.setText("ID: " + String.valueOf(Financiamento.listaVeiculos.get(2).getId()));
            valor3.setText("Valor: R$ " + String.valueOf(Financiamento.listaVeiculos.get(2).getValor()));
        }
        
        if (Financiamento.size >= 4) {
            cardTitle4.setText(Financiamento.listaVeiculos.get(3).getNome());
            nome4.setText("Nome: " + Financiamento.listaVeiculos.get(3).getNome());
            fabricante4.setText("Fabricante: " + Financiamento.listaVeiculos.get(3).getFabricante());
            id4.setText("ID: " + String.valueOf(Financiamento.listaVeiculos.get(3).getId()));
            valor4.setText("Valor: R$ " + String.valueOf(Financiamento.listaVeiculos.get(3).getValor()));
        }
        
        if (Financiamento.size >= 5) {
            cardTitle5.setText(Financiamento.listaVeiculos.get(4).getNome());
            nome5.setText("Nome: " + Financiamento.listaVeiculos.get(4).getNome());
            fabricante5.setText("Fabricante: " + Financiamento.listaVeiculos.get(4).getFabricante());
            id5.setText("ID: " + String.valueOf(Financiamento.listaVeiculos.get(4).getId()));
            valor5.setText("Valor: R$ " + String.valueOf(Financiamento.listaVeiculos.get(4).getValor()));
        }
        
        if (Financiamento.size >= 6) {
            cardTitle6.setText(Financiamento.listaVeiculos.get(5).getNome());
            nome6.setText("Nome: " + Financiamento.listaVeiculos.get(5).getNome());
            fabricante6.setText("Fabricante: " + Financiamento.listaVeiculos.get(5).getFabricante());
            id6.setText("ID: " + String.valueOf(Financiamento.listaVeiculos.get(5).getId()));
            valor6.setText("Valor: R$ " + String.valueOf(Financiamento.listaVeiculos.get(5).getValor()));
        }
    }
    ...
    private javax.swing.JLabel fabricante2;
